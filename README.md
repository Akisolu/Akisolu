...
* ⚙️ **[python-cli-ci-cd-showcase](https://github.com/Akisolu/python-cli-ci-cd-showcase)** — Python CLI CI/CD pipeline with pytest testing, PyInstaller cross-builds, and automated GitHub releases
